                ...
                <div class="row">
                    ...
                    {{-- <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select name="paid_type" class="form-select" id="paidType">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" readonly name="total_amount" id="total_amount" class="form-control @error('total_amount') {{ 'is-invalid' }} @enderror" value="{{ old('total_amount') }}" placeholder="Enter amount">
                            <small>
                                @error('total_amount')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" id="paidAmount" name="paid_amount" class="form-control @error('paid_amount') {{ 'is-invalid' }} @enderror" value="{{ old('paid_amount') }}" placeholder="Enter paid amount">
                            <small>
                                @error('paid_amount')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="month" name="month" id="month" class="form-control @error('month') {{ 'is-invalid' }} @enderror" value="{{ old('month') }}">
                            <small>
                                @error('month')
                                    {{ $message }}
                                @enderror
